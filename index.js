    ...
    // 487 === john
      ...
      characters.push(
        new Character({
          ...
          endDialogue: [
            "Погоди, этот почерк...",
            "Ты к бабушке приехал? Тебе нужно принести бабушке яйца?",
            "Вот. бери! Вижу тебе нужно молоко, оно есть у Френка!",
            "Вы получили яйца!",
          ],
    ...
    // 486 === babka
      ...
      characters.push(
        new Character({
          ...
          introDialogue: [
            "Доброе утро, внучёк!",
            "Я хочу сделать тебе сюрприз, но для этого ты должен кое что принести.",
            "Вы получили список предметов! (нажмите C для просмотра)",
          ],
...
const init = () => {
  ...
  renderables = [background, ...boundaries, ...characters, chicken, player, foreground];
};
